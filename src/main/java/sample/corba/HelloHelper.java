...
abstract public class HelloHelper
{
  ...
  public static sample.corba.Hello extract (org.omg.CORBA.Any a)
  {
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.ORB.init ().create_interface_tc (sample.corba.HelloHelper.id (), "Hello");
    }
    return __typeCode;
  }
  ...
  public static sample.corba.Hello read (org.omg.CORBA.portable.InputStream istream)
  {
  ...
  public static sample.corba.Hello narrow (org.omg.CORBA.Object obj)
  {
    if (obj == null)
      return null;
    else if (obj instanceof sample.corba.Hello)
      return (sample.corba.Hello)obj;
    else if (!obj._is_a (id ()))
      throw new org.omg.CORBA.BAD_PARAM ();
    else
    {
      org.omg.CORBA.portable.Delegate delegate = ((org.omg.CORBA.portable.ObjectImpl)obj)._get_delegate ();
      sample.corba._HelloStub stub = new sample.corba._HelloStub ();
      stub._set_delegate(delegate);
      return stub;
    }
  }

  public static sample.corba.Hello unchecked_narrow (org.omg.CORBA.Object obj)
  {
    if (obj == null)
      return null;
    else if (obj instanceof sample.corba.Hello)
